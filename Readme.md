...
### Option 1: Quick Install (Auto-installs Python)
**Best for:** First-time users, no setup required
...
### Option 2: Download Executable (Fastest, Recommended)
**Best for:** Quick use, no Python installation, portable
